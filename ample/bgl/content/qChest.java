...
public class qChest extends BlockChest{
	
private final Random field_149955_b = new Random();
	
protected qChest(int chest){
	super(chest);
}
...
public void onNeighborBlockChange(World p_149695_1_, int p_149695_2_, int p_149695_3_, int p_149695_4_, Block p_149695_5_)
{
    ...
    TileEntity tileentityqchest = (TileEntity)p_149695_1_.getTileEntity(p_149695_2_, p_149695_3_, p_149695_4_);

    if (tileentityqchest != null)
    {
        final Random field_149955_b = new Random();
        tileentityqchest.updateContainingBlockInfo();
    }
}
...
public IInventory func_149951_m(World p_149951_1_, int p_149951_2_, int p_149951_3_, int p_149951_4_)
{
    ...
    else
    {
        ...
        {
            object = new InventoryLargeChest("Large Quantum Chest", (IInventory)p_149951_1_.getTileEntity(p_149951_2_ - 1, p_149951_3_, p_149951_4_), (IInventory)object);
        }

        if (p_149951_1_.getBlock(p_149951_2_ + 1, p_149951_3_, p_149951_4_) == this)
        {
            object = new InventoryLargeChest("Large Quantum Chest", (IInventory)object, (TileEntityQChest)p_149951_1_.getTileEntity(p_149951_2_ + 1, p_149951_3_, p_149951_4_));
        }

        if (p_149951_1_.getBlock(p_149951_2_, p_149951_3_, p_149951_4_ - 1) == this)
        {
            object = new InventoryLargeChest("Large Quantum Chest", (TileEntityQChest)p_149951_1_.getTileEntity(p_149951_2_, p_149951_3_, p_149951_4_ - 1), (IInventory)object);
        }

        if (p_149951_1_.getBlock(p_149951_2_, p_149951_3_, p_149951_4_ + 1) == this)
        {
            object = new InventoryLargeChest("Large Quantum Chest", (IInventory)object, (TileEntityQChest)p_149951_1_.getTileEntity(p_149951_2_, p_149951_3_, p_149951_4_ + 1));
        }
...
{
    TileEntityQChest tileentitychest = new TileEntityQChest();
    return tileentitychest;
}
@SideOnly(Side.CLIENT)
public void registerBlockIcons(IIconRegister p_149651_1_)
{
    this.blockIcon = p_149651_1_.registerIcon(AmpleMod.MODID + ":qChest");
}
}
